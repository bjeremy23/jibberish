...
class TestLinuxCommandTool(unittest.TestCase):
    ...
    def test_exception_handling(self, mock_prompt):
        ...
        with patch('app.tools.linux_command.execute_command_with_built_ins') as mock_execute:
            ...
            mock_prompt.assert_called_once_with("'some command'")
            self.assertIn("ERROR:", result)
            self.assertIn("Unexpected error occurred", result)

    @patch('app.tools.linux_command.prompt_before_execution', return_value=True)
    @patch('app.tools.linux_command.execute_command_with_built_ins')
    def test_warn_list_security_check_single_command(self, mock_execute, mock_prompt):
    ...
    @patch('app.tools.linux_command.prompt_before_execution', return_value=True)
    @patch('app.tools.linux_command.execute_command_with_built_ins')
    def test_warn_list_partial_match(self, mock_execute, mock_prompt):
    ...
    @patch('app.tools.linux_command.prompt_before_execution', return_value=True)
    @patch('app.tools.linux_command.execute_command_with_built_ins')
    def test_warn_list_safe_commands(self, mock_execute, mock_prompt):
    ...
    @patch('app.tools.linux_command.prompt_before_execution', return_value=True)
    @patch('app.tools.linux_command.execute_command_with_built_ins')
    def test_warn_list_case_sensitivity(self, mock_execute, mock_prompt):
    ...
    @patch('app.tools.linux_command.prompt_before_execution', return_value=True)
    @patch('app.tools.linux_command.execute_command_with_built_ins')
    def test_command_whitespace_handling(self, mock_execute, mock_prompt):
